...
export class SAXParser {
    ...
    resume(checkpoint, expectedConsumedBytes) {
        ...
        new DataView(memory.buffer).setBigUint64(offsetPointer, BigInt(expectedConsumedBytes ?? readCheckpointConsumedBytes(checkpoint)), true);
 ...
 */
export const readCheckpointConsumedBytes = (checkpoint) => {
...
const validateCheckpointHeader = (checkpoint, events, expectedConsumedBytes) => {
    ...
    if (version !== CHECKPOINT_VERSION) {
        throw new CheckpointError(`Unsupported checkpoint format version ${version}; this build supports version ${CHECKPOINT_VERSION}.`, -2 /* CheckpointErrorCode.UnsupportedVersion */);
    }
